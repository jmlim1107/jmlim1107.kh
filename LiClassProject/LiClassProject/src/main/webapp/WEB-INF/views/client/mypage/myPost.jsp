...
<!-- Theme CSS resources/client/mypage/post/-->  
<link id="theme-style" rel="stylesheet" href="/resources/client/mypage/post/assets/css/theme-1.css">
<h4>나의 클래스일지</h4>
	<div>
	    <section class="blog-list px-3 py-5 p-md-5">
		    <div class="container">
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-7.jpg" alt="image">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-8.jpg" alt="image">
					    <div class="media-body">
						    <h3 class="title mb-1"><a href="blog-post.html">Heading Lorem Ipsum Dolor Sit Amet</a></h3>
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-9.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-10.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-11.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="resources/client/mypage/post/assets/images/blog/blog-post-thumb-12.jpg" alt="image">
					    <div class="media-body">
    ...
    <!-- Javascript -->          
    <script src="resources/client/mypage/post/assets/plugins/jquery-3.3.1.min.js"></script>
    <script src="resources/client/mypage/post/assets/plugins/popper.min.js"></script> 
    <script src="resources/client/mypage/post/assets/plugins/bootstrap/js/bootstrap.min.js"></script> 
    
    <!-- Style Switcher (REMOVE ON YOUR PRODUCTION SITE) -->
    <script src="resources/client/mypage/post/assets/js/demo/style-switcher.js"></script>     